...
// firstName = "Chris";
// console.log(firstName); can not reasigne
...
// console.log(`My name is ${name}  . Im ${age} My favourite drink is  ${favDrink} `);
...
let age = 20;
let favColour = "blue";
console.log(`His name is ${name}, He is ${age} years ols. His fauvorite colour is ${favColour}.`);
...
let newYear = new Date(today.getFullYear(), 12,31);
if ( today.getMonth()==1 && today.getDay()>16){
